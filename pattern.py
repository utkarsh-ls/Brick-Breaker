...
def setup3(board):
    ...
    for i in range(0, 41):
        board.append([brickcol[0]] * 40)
    # board[9][1] = colors.bg.lightgrey + '  ' + colors.reset
    # print(type(board[3][3]))
    # print(type(brickcol[2]))
    for i in range(6, 11):
        board[i][3] = brickcol[2]
        board[i][18] = brickcol[2]
        if(i < 9):
    ...
    ######## exploding bricks starts
    for i in range(12, 16):
        board[i][3] = brickcol[5]
        board[i][18] = brickcol[5]
        bricks1.append([i,3])
        bricks1.append([i,8])
        bricks2.append([i,18])
        bricks2.append([i,13])
    bricks1.append([11,3])
    bricks1.append([11,4])
    bricks2.append([11,17])
    bricks2.append([11,18])
    bricks1.append([16,3])
    bricks1.append([16,4])
    bricks2.append([16,17])
    bricks2.append([16,18])
    for j in range (4, 8):
        board[13][j] = brickcol[5]
        board[13][j+10] = brickcol[5]
        board[14][j] = brickcol[5]
